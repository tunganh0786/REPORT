...
const getCurrentHourStr = () => {
  ...
  // Sáng (trước 12h) -> 10h, Chiều (sau 12h) -> 15h
...
// Cập nhật hàm formatToK: Làm tròn số nguyên, không lấy số sau dấu chấm
const formatToK = (val: string | number): string => {
  ...
  if (num >= 1000 || num === 0) {
    // Làm tròn thành số nguyên gần nhất trước khi thêm chữ 'k'
...
const App: React.FC = () => {
  ...
  // Tự động cập nhật thời gian thực mỗi 30 giây
  useEffect(() => {
            ...
            <div className="p-6 bg-blue-500/5 border border-blue-500/10 rounded-3xl">
               <div className="flex gap-4">
                 ...
                 <div className="space-y-1">
                   <h4 className="text-sm font-bold text-blue-400 uppercase tracking-wide">Làm tròn doanh số</h4>
                   <p className="text-xs text-slate-400 leading-relaxed">
                     Doanh số và chi phí giờ đây được <span className="text-white font-bold">làm tròn số nguyên</span> khi hiển thị đơn vị "k" (Ví dụ: 120.5k → 121k) giúp báo cáo gọn gàng hơn.
                   </p>
                 </div>
               </div>
            </div>
